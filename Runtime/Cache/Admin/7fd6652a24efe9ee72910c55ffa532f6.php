        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                    <td>
                        <input name="" type="checkbox" value="<?php echo ($vol["role_id"]); ?>" />
                    </td>
                    <td><?php echo ($vol["role_id"]); ?></td>
                    <td><?php echo ($vol["role_name"]); ?></td>
                    <td><?php echo ($vol["role_auth_ids"]); ?></td>
                    <td><?php echo ($vol["role_auth_ac"]); ?></td>
                    <td><a href="/index.php/Admin/Role/setAuth/role_id/<?php echo ($vol["role_id"]); ?>" class="tablelink">设置权限</a> <a href="#" class="tablelink"> 删除</a></td>
